                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    ...
                                    <form class="user" id="userLogin">
                                        ...
                                        <a href="#" class="btn btn-primary btn-user btn-block" id='buttonLogin' onclick="userLogin();">
                                            Login
                                        </a>
                                        <!-- <hr>
        ...
        async function checkInputLogin()
        {
            try
            {
                ...
                for(const elem of forms)
                {
                    if($(`#${elem.id}`).val() == '')
                    {
                        $(`#${elem.id}`).addClass('input-login-empty');
                    ...
                    {
                        $(`#${elem.id}`).removeClass('input-login-empty');
                    }
                }
